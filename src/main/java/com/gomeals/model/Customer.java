...
public class Customer {
    ...
    public Customer(int cust_id, String cust_fname, String cust_lname, String cust_address, String cust_email, String cust_card_details, String cust_contact_number) {
